                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-4 float-left">
                        ...
                        <input type="hidden" id="type" value="Invoice">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-2 float-left">Invoice No</div>
                      <div class="col-md-4 float-left">
                        <input type="text" class="form-control" id="slno" placeholder="Invoice No">
                      </div>
                    </div>
                  </div>
                            ...
                            <table class="table table-bordered">
                              ...
                              <tbody>
                                <tr>
                                  <td>+</td>
                                  <td>1.</td>
                                  <td><input type="text" class="form-control" id="slno" placeholder="Invoice No"></td>
