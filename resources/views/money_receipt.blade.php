        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">New Money Receipts</h4>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-4 float-left">
                        ...
                        <input type="hidden" id="type" value="money_receipt">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-2 float-left">Money Receipts No</div>
                      <div class="col-md-4 float-left">
                        <input type="text" class="form-control" id="slno" placeholder="Money Receipts No">
                      </div>
                    </div>
                  </div>
                            ...
                            <table class="table table-bordered">
                              ...
                              <tbody>
                                <tr>
                                  <td>+</td>
                                  <td>1.</td>
                                  <td><input type="text" class="form-control" id="slno" placeholder="Money Receipts No"></td>
